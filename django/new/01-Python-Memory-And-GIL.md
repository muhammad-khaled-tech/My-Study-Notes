...
تخيّل معايا إن الـ memory بتاعة Python زي مستودع ضخم. كل قيمة — رقم، string، list، function، حتى `True` و`False` — موجودة جوّاه كـ "صندوق." المتغير بتاعك مش الصندوق نفسه — هو **ورقة كتبان عليها عنوان** الصندوق ده جوّا المستودع.
