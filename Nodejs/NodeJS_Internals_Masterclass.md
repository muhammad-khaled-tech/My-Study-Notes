...
**الـ Process** هو ببساطة "برنامج شغال في الـ RAM". لما بتفتح Chrome، الـ OS بيخلق Process ليه في الميموري. لما بتشغل VS Code، Process تانية. كل Process ليها مساحة ميموري **معزولة تماماً** عن باقي الـ Processes — Chrome مش يقدر يقرأ ميموري VS Code. الـ **RAM** (Random Access Memory) هي الذاكرة السريعة المؤقتة اللي البرامج بتشتغل فيها.
