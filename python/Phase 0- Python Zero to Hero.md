...
هنبدأ النهارده رحلة **Phase 0: Python Zero to Hero** — الأساس المتين اللي هيخلي الـ 18 فايل اللي فاتوا سلسين وبديهيين.

هنمشي على نفس الـ DNA بتاعنا: 🧠 شرح نظري صافي (بدون كود)، 📊 رسم Mermaid واحد بسيط، 💻 مثال صغير مركز، 🛠️ Progressive Exercise تراكمي في الآخر.

يلا بينا نبدأ أول فايل...

---

# الفصل صفر-صفر — Python Syntax والـ Data Types: أول خطوة في الرحلة
