...
**DDoS = Distributed Denial of Service**. الفكرة بسيطة ومؤلمة: المهاجم بدل ما يهاجم من كمبيوتر واحد، بيتحكم في آلاف أو ملايين الأجهزة المصابة (بتتسمى **Bots** أو **Botnets**) وبيوجّههم كلهم في نفس الوقت يرسلوا Requests لموقعك. السيرفر بيتخنق ويبطّل يخدم المستخدمين الحقيقيين. موقعك بيقع — وانت ما قادر تعمل حاجة.

الهجمات دي كانت فيما مضى تودي شركات كاملة. دلوقتي AWS عندها طبقات دفاع متعددة.

---

## 🛡️ AWS Shield — الدرع ضد الـ DDoS

الـ **AWS Shield** هو الخدمة المتخصصة في حماية الـ Infrastructure بتاعتك من هجمات الـ DDoS. بييجي في نسختين بتناسبا حالات مختلفة.

**AWS Shield Standard** هو الحماية الافتراضية اللي كل عميل AWS بياخدها **تلقائياً ومجاناً** من غير ما يطلب أو يدفع. بتحميك من أكتر هجمات الـ DDoS شيوعاً — الـ SYN/UDP Floods والـ Reflection Attacks واللي بيشتغل على الـ Layer 3 وLayer 4 (الشبكة والنقل). الحماية دي في الخلفية دايماً، حتى لو ما عرفتش.

**AWS Shield Advanced** هو الدرع الثقيل — وبييجي بتكلفة **$3,000 في الشهر لكل Organization**. ده مش للجميع — ده للشركات الكبيرة اللي الهجوم عليها ممكن يكلّفها ملايين. ماذا بتاخد؟ حماية أعمق ضد هجمات أكتر تعقيداً على EC2 وELB وCloudFront وGlobal Accelerator وRoute 53. أهم حاجة فيه على الإطلاق: **24/7 وصول للـ DDoS Response Team (DRT) في AWS** — ناس متخصصة بتساعدك وقت الهجوم الفعلي. وكمان بيحميك من الفواتير الزيادة — لو الهجوم خلى الـ Traffic يقفز وزادت فاتورتك، AWS بتعوّضك.
