...
## 3. Real Engineering Usage (الاستخدام الهندسي والـ OAC)

جزء مهم جداً إنت ذكرته وهو **Origin Access Control (OAC)**.
...
الـ CloudFront مش بيكش ملقات S3 بس. الـ **Origin** (المصدر) بتاعه ممكن يكون:
