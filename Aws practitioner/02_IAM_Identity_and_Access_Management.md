...
لما بتفتح AWS Account جديدة، أول حاجة بتحصل هي إن الـ Cloud بيديك مفتاحاً واحداً يفتح كل الأبواب — اسمه **Root Account**. ده الأكونت الإلهي. مفيش صلاحية ممنوعة عليه، مفيش قيد بيوقفه. يقدر يحذف كل الـ Resources، يغير الـ Billing، يلغي الـ Account نفسها.
