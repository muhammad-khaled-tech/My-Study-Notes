...
يا أهلاً بك يا دكتور في "بيت القصيد" وجوهرة التاج في عالم هياكل البيانات.
إحنا دلوقتي قدام الـ **Binary Search Tree (BST)**. لو كانت الشجرة الثنائية العادية اللي شرحناها المرة اللي فاتت هي "الهيكل"، فالـ BST هي "العقل المفكر".
