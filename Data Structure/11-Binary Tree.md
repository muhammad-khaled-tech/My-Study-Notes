...
2. بنزور الأب الأول، وبعدين ولاده. (تستخدم لعمل نسخة من الشجرة).
    
3. **In-order (Left, Root, Right):**
4. بنزور الابن الشمال، وبعدين الأب، وبعدين الابن اليمين. (في الـ BST، الطريقة دي بتطبع الداتا **مترتبة**!).
    
5. **Post-order (Left, Right, Root):**
6. بنزور الولاد الأول وبعدين الأب. (تستخدم لمسح الشجرة من الميموري أو حساب حجم الفولدرات).
