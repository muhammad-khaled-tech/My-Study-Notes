...
تخيل إنت بتقرأ جملة عربية: "أحمد بيكتب كود PHP". دماغك بتقسّمها لكلمات تلقائياً. الـ Lexer بيعمل نفس الحاجة — بياخد ملف الـ PHP كـ نص خام وبيقطعه لـ **Tokens** (وحدات صغيرة).
...
![[Pasted image 20260507024236.png]]
---
