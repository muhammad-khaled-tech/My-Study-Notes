...
## Appendix: volatile vs synchronized (مقارنة مهمة) 🔥
...
5. **النتيجة:** المفروض يبقوا 2، بس النتيجة طلعت 1. هنا `volatile` فشلت.
...
| **Keyword** | **Visibility** | **Atomicity** | **الاستخدام** |
|:--|:--:|:--:|:--|
| `volatile` | ✅ | ❌ | متغير **واحد بيغيره** والكل بيتفرج (stop flag) |
| `synchronized` | ✅ | ✅ | متغير **الكل بيغير فيه** (رصيد بنك، عداد) |
