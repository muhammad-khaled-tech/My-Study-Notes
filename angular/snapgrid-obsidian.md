---
title: "SnapGrid — Graduation Project Plan"
description: "Instagram-style social platform — Junior Frontend Developer Roadmap"
tags:
  - angular
  - tailwind
  - typescript
  ...
  - frontend
status: in-progress
stack: "Angular 18+ · Tailwind CSS · TypeScript · RxJS"
total_phases: 15
hours_estimate: "102-121 h"
created: 2024-01-01
aliases:
  - SnapGrid Plan
  - Grad Project
...
> **Stack:** Angular 18+ · Tailwind CSS · TypeScript · RxJS  
> **Scope:** 15 phases · 102-121 hours · 12-14 weeks  
> **Audience:** Junior Frontend Developer  
> **Includes:** GitHub workflow · CI/CD · Code Reviews · Mock API contract
...
> This is your **single source of truth**. Treat it like a real junior developer would treat a project spec at a company.
...
## 📚 Study Checklist — Before Phase 0
...
> [!tip] 📖 [Git — the simple guide](https://rogerdudler.github.io/git-guide/) (15 min read)
> [!tip] 📖 [GitHub Hello World guide](https://docs.github.com/en/get-started/quickstart/hello-world)
...
> [!tip] 📖 Angular tutorial Part 1 (your guide) — "Project structure" section
...
> [!tip] 📖 [Tailwind CSS — Core Concepts](https://tailwindcss.com/docs/utility-first) (20 min)
...
> ⏱ **Estimate:** 2–3 hours  
> 🧠 **Focus:** Angular CLI, Tailwind, Git workflow
...
## 📚 Study Checklist — Before Phase 1
...
> [!tip] 📖 [Tailwind — Flexbox](https://tailwindcss.com/docs/flex), [Spacing](https://tailwindcss.com/docs/padding), [Colors](https://tailwindcss.com/docs/customizing-colors)
...
> [!tip] 📖 [Tailwind — Dark Mode docs](https://tailwindcss.com/docs/dark-mode)
...
> [!tip] 📖 Angular tutorial Part 3 (your guide) — Reactive Forms chapter
...
> [!tip] 📖 Angular tutorial Part 4 (your guide) — Angular Signals chapter
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — Guards section
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 4–6 hours  
> 🧠 **Focus:** Tailwind CSS utility-first styling
...
> [!warning] `login.ts`
> `loading` and `serverError` are plain `boolean` and `string` properties. We use signals everywhere in this project — please convert to `loading = signal(false)` and `serverError = signal('')`. Consistency matters more than you think when the codebase grows.
...
## 📚 Study Checklist — Before Phase 2
...
> [!tip] 📖 Angular tutorial Part 4 (your guide) — Routing Deep Dive chapter
...
> [!tip] 📖 Angular tutorial Part 7 (your guide) — Lazy Loading section
...
> [!tip] 📖 Angular tutorial Part 4 — Navigation extras section
...
> [!tip] 📖 [Tailwind — Responsive Design](https://tailwindcss.com/docs/responsive-design)
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — Route structure section
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–7 hours  
> 🧠 **Focus:** Layout components + Responsive design
...
> [!warning] `app.routes.ts`
> You have `{ path: '', redirectTo: '/feed', pathMatch: 'full' }` at the end of the children array — good. But I see the catch-all `{ path: '**' }` is inside the authenticated shell. Move it OUTSIDE the shell so unauthenticated users who hit a bad URL also get redirected, not stuck on a blank shell page.
...
> [!tip] 📖 Angular tutorial Part 4 (your guide) — Component Communication chapter
...
> [!tip] 📖 Angular tutorial Part 7 (your guide) — OnPush section
...
> [!tip] 📖 Angular tutorial Part 4 (your guide) — Signals chapter
...
> [!tip] 📖 [TypeScript Handbook — Interfaces](https://www.typescriptlang.org/docs/handbook/2/objects.html)
...
> [!tip] 📖 Angular tutorial Part 7 (your guide) — Pure Pipes section
...
> [!tip] 📖 [Tailwind — Aspect Ratio](https://tailwindcss.com/docs/aspect-ratio)
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 6–8 hours  
> 🧠 **Focus:** @Input/@Output + Component composition
...
> [!warning] `feed.ts`
> Mock data is hardcoded inside the component. Move it to `core/mocks/posts.mock.ts`. Two reasons: (1) when you switch to real API in Phase 6 you delete one file, not scattered inline arrays; (2) other components (explore, profile) might need the same mock data during development.


> [!success] `time-ago.pipe.ts`
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–6 hours  
> 🧠 **Focus:** File input, image preview, FormData upload
...
### 👨‍💻 Code Review — Phase 3.5


> [!danger] file validation
...
> [!warning] `removeImage()`
> `URL.revokeObjectURL()` is called when removing — correct. Is it also called in `ngOnDestroy`? What if the user navigates away without removing the image? Memory leak. Make sure ngOnDestroy also revokes it.
...
## 📚 Study Checklist — Before Phase 4
...
> [!tip] 📖 Angular tutorial Part 4 (your guide) — Route Parameters section
...
> [!tip] 📖 Angular tutorial Part 4 (your guide) — computed() section
...
> [!tip] 📖 [Tailwind — Grid Template Columns](https://tailwindcss.com/docs/grid-template-columns)
...
> [!tip] 📖 Search "optimistic UI pattern React/Angular" — the concept is framework-agnostic
...
> [!tip] 📖 Angular tutorial Part 1 (your guide) — Lifecycle Hooks section
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–7 hours  
> 🧠 **Focus:** Route parameters + Signals for page state
...
> [!success] `profile.ts` — `isOwnProfile` computed
...
> [!warning] the missing case
> What happens when `getProfile('nonexistent-user')` returns a 404? The page shows... nothing? Add an empty/error state: a centered message "User not found" with a back link. Every data-loading page needs three states: loading, error, and success.
...
## 📚 Study Checklist — Before Phase 5
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — Services section
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — HTTP section
...
> [!tip] 📖 Angular tutorial Part 1 (your guide) — TypeScript Generics section
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — RxJS section
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–6 hours  
> 🧠 **Focus:** Nested routes + Component data flow
...
## 📚 Study Checklist — Before Phase 6
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — Interceptors section
...
> [!tip] 📖 Angular tutorial Part 7 (your guide) — Retry Logic section
...
> [!tip] 📖 Angular tutorial Part 9 (your guide) — Environment Files chapter
...
> [!tip] 📖 [jwt.io](https://jwt.io) — paste a token to see its contents (great for understanding)
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 4–5 hours  
> 🧠 **Focus:** HTTP error handling + loading states
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 3–4 hours  
> 🧠 **Focus:** Angular ErrorHandler + global UX
...
### 👨‍💻 Code Review — Phase 6.5


> [!note] `AppErrorHandler`
...
> The toast container uses `fixed top-4 end-4` — correct for RTL. But what about mobile? `w-80` (320px) might overflow on a 375px screen. Use `max-w-[calc(100vw-2rem)]` instead so it's always contained.
...
## 📚 Study Checklist — Before Phase 7
...
> [!tip] 📖 Angular tutorial Part 5 (your guide) — Angular Animations chapter (read the WHOLE chapter before starting)
...
> [!tip] 📖 Angular tutorial Part 7 (your guide) — @defer section
...
> [!tip] 📖 [Tailwind — Position](https://tailwindcss.com/docs/position)
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 6–8 hours  
> 🧠 **Focus:** Angular Animations + @defer
...
## 📚 Study Checklist — Before Phase 8
...
> [!tip] 📖 [MDN — CSS Logical Properties](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_logical_properties_and_values)
> [!tip] 📖 [Tailwind — RTL support](https://tailwindcss.com/docs/hover-focus-and-other-states#rtl-support)
...
> [!tip] 📖 [Google Fonts — Cairo](https://fonts.google.com/specimen/Cairo)
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–7 hours  
> 🧠 **Focus:** Global state services + CSS direction
...
## 📚 Study Checklist — Before Phase 9
...
> [!tip] 📖 [Tailwind — Animation](https://tailwindcss.com/docs/animation)
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 4–5 hours  
> 🧠 **Focus:** Reusable loading components
...
## 📚 Study Checklist — Before Phase 10
...
> [!tip] 📖 Angular tutorial Part 5 (your guide) — Custom Directives section
...
> [!tip] 📖 [MDN — Intersection Observer API](https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API) (read the "Concepts" section)
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — switchMap section
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–6 hours  
> 🧠 **Focus:** Custom directive + IntersectionObserver API
...
## 📚 Study Checklist — Before Phase 11
...
> [!tip] 📖 [RxJS — interval](https://rxjs.dev/api/index/function/interval), [startWith](https://rxjs.dev/api/operators/startWith)
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — BehaviorSubject section
...
> [!tip] 📖 Angular tutorial Part 7 (your guide) — takeUntilDestroyed section
...
> [!tip] 📖 Angular tutorial Part 2 (your guide) — async pipe section
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–7 hours  
> 🧠 **Focus:** RxJS polling + BehaviorSubject for shared state
...
## 📚 Study Checklist — Before Phase 12
...
> [!tip] 📖 [MDN — Progressive Web Apps](https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps) (read the "Introduction" and "Installable" sections)
...
> [!tip] 📖 [Angular — Service Worker Introduction](https://angular.io/guide/service-worker-intro)
...
> [!tip] 📖 [Angular — Getting started with Service Workers](https://angular.io/guide/service-worker-getting-started)
...
> [!tip] 📖 [MDN — Web App Manifest](https://developer.mozilla.org/en-US/docs/Web/Manifest)
...
> [!tip] 📖 [Lighthouse PWA Checklist](https://web.dev/pwa-checklist/)
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 3–4 hours  
> 🧠 **Focus:** Angular PWA + Service Worker
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 6–7 hours  
> 🧠 **Focus:** debounceTime + switchMap search, tab navigation
...
> [!warning] empty state
> "No results for X" only appears after a search. What about the initial load of trending posts failing? Add an error signal and show "Couldn't load trending content. Tap to retry" with a retry button.
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 5–6 hours  
> 🧠 **Focus:** PATCH requests, avatar upload with preview, form pre-fill
...
> [!warning] `patchValue` pre-fill
> Pre-filling works, but `getCurrentUser()` reads from the JWT payload — it might be stale if the user edited their profile from another device. Consider fetching fresh data from `GET /auth/me` in `ngOnInit` and pre-filling from the API response instead.
...
> [!abstract] Phase Overview
> ⏱ **Estimate:** 8–10 hours  
> 🧠 **Focus:** Jasmine, TestBed, HttpTestingController, test coverage
...
> [!warning] mock data
> You've copy-pasted the `mockPost` object in three different spec files. Extract it to `src/app/core/mocks/post.mock.ts` and import it. Same for `mockUser`. Duplication in tests is as bad as duplication in source code.


> [!success] what NOT to test
