...
7. كومنتات الكود: أي كومنت جوه الـ code blocks لازم يكون بالإنجليزي بالكامل — حتى لو باقي الملف بالعربي. (مثال: `// move right pointer forward` مش `// حرك الـ pointer اليمين`).
